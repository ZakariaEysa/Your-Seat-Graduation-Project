        ...
        child: Column(
          children: [
            ...
            SizedBox(
                height: 500.h,
                child: CinemaMovies(
                  movies: widget.cinemaModel['movies'],
                )),
            Padding(
                ...
                Expanded(
                  child: Padding(
                    padding: EdgeInsets.all(
                        12.sp), // استخدام .sp لجعل التباعد متجاوبًا
                    child: TextFormFieldBuilder(
                      controller:
                          context.read<CinemaCubit>().getCommentController,
                      type: TextInputType.text,
                      width: double
                          .infinity, // استخدام `double.infinity` لجعله يتمدد تلقائيًا
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(
                        12.r), // استخدام .r لتكبير الحواف بشكل متناسق
                  ),
                  child: IconButton(
                    ...
                    onPressed: () async {
                      ...
                      await CinemaCubit.get(context)
                          .fetchCinemaComments(widget.cinemaModel['name']);
                    },
                  ),
                ),
                SizedBox(width: 18.w),
