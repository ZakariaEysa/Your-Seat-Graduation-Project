...
class _NewPasswordState extends State<NewPassword> {
  ...
  listener: (context, state) {
    if (state is UpdatePasswordSuccess) {
      ...
      navigateAndReplace( context: context, screen: SignIn());
      ...
      BotToast.showText(text:lang.SorryThereWasAnErrorPleaseTryAgainLater);
                  ...
                  children: [
                    ...
                    ButtonBuilder(
                      ...
                      onTap: ()  async{
                       ...
                       await  cubit.updateUserPassword(cubit.emailController.text,newPasswordController.text);
